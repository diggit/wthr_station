function load_values() 
{
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			...
			document.getElementById("Alight").innerHTML=splittered[3]+" lux";
			document.getElementById("stamp").innerHTML="změřeno "+splittered[4]+", aktualizováno "+time.getHours()+":"+leftPad(time.getMinutes(),2)+":"+leftPad(time.getSeconds(),2);
			document.getElementById("status").innerHTML=splittered[5];
			document.getElementById("status_extended").innerHTML=splittered[6];
			notify("stamp")
		}
	}
