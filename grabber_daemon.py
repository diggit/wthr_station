...
def gen_image(data,Xcol,Ycol,ImgName,LineColor, logY = False):
	...
	if GENchart:
		...
		pl.figure(figsize=(9,3.5), dpi=300)
		...
		#adjust subplot
		pl.subplots_adjust(bottom=0.1, left=0.07,right=1-0.07)
		...
		if GEN_HIRES:
			...
			pl.savefig(PATH+"charts/"+ImgName+".png",dpi=300, transparent=True)

		printDBG("IMG: saving low resolution file")
		pl.savefig(PATH+"charts/"+ImgName+"-lowres.png",dpi=100, transparent=True)
